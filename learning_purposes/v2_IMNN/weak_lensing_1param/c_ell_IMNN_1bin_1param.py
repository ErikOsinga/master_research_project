...
class nholder(object):
    ...
    def __init__(self, input_shape, generate_data, theta_fid, delta_theta, n_s, n_train, 
        derivative_fraction, n_train_val, derivative_fraction_val, eta, parameters, num_epochs, keep_rate, verbose, dtype, training_dictionary, validation_dictionary, network, version, fromdisk, noiseless_deriv, flatten, load_network=False):
        """
