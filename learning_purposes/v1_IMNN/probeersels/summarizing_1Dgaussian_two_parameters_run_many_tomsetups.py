...
def plot_data():
	...
	plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/data_visualization_%i.png'%version)
	plt.close()
...
def plot_data_hist():
	...
	plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/data_visualization_hist_%i.png'%version)
	plt.close()
...
def plot_derivatives():
	...
	plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/derivatives_visualization_%i.png'%version)
	plt.close()
...
def plot_variables():
	...
	plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/variables_vs_epochs_%i.png'%version)
	# plt.show()
	plt.close()
...
def ABC():
	...
	def show_real_data():
		...
		plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/real_data_%i.png'%version)
		plt.close()
	...
	def plot_samples():
		...
		plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/ABC_%i.png'%version)
		plt.close()
...
def PMC_ABC():
	...
	def plot():
		...
		ax[1].set_yticks([]);
		plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/PMC_ABC_%i.png'%version)
		plt.close()
		# plt.show()
	plot()
...
def first_order_Gaussian_MLE():
	...
	def plot():
		...
		ax.set_yticks([])
		plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/Gaussian_MLE_dense_%i.png'%version)
		plt.close()
...
ax.set_ylabel('$\\mathcal{P}(\\theta|{\\bf d})$')
ax.set_yticks([])
plt.savefig('./Figures/1d_gaussian2params/tom_setup/many_runs/likelihoods_dense_%i.png'%version)
# plt.show()
plt.close()
