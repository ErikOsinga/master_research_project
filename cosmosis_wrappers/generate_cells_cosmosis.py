...
def write_cosmosis_file(save_dir):
	...
	with open('./generate_cells.ini','w') as file:
		...
		file.write('ell_min = 20.0\n')
		file.write('ell_max = 10000.0\n')
		file.write('n_ell = 220\n')
...
if __name__ == "__main__":
	# Folder where cosmosis is installed
	cosmosis_dir = '/net/reusel/data1/osinga/cosmosis_installation/cosmosis/'
