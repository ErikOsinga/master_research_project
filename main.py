...
"""
Meant to be used as a general main.py for other projects
At the moment is still implemented for 1D Gaussian with unkown mu sigma
...
# # Plot upper and lower simulations
...
# prior = [0, 6]
# draws = 100000
# nholder1.ABC(n, real_data, prior, draws)
